...
class JPacket(ReadWriteKaitaiStruct):
    ...
    def _read(self):
        ...
        if not (self.packet_type == b"\x4A"):
            raise kaitaistruct.ValidationNotEqualError(b"\x4A", self.packet_type, self._io, u"/seq/0")
    ...
    def _write__seq(self, io=None):
        super(JPacket, self)._write__seq(io)
    ...
    def _check(self):
        ...
        if not (self.packet_type == b"\x4A"):
            raise kaitaistruct.ValidationNotEqualError(b"\x4A", self.packet_type, None, u"/seq/0")
